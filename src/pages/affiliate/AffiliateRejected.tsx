...
import { XCircle, Info, ArrowLeft, Star } from 'lucide-react';

export default function AffiliateRejected() {
    // Mock data - will come from backend
    const rejectionReason = 'Akun media sosial yang diberikan tidak dapat diakses atau bersifat privat.';
                        ...
                        <div className="p-5 md:p-7 lg:p-8">
                            ...
                            <div className="flex flex-col items-center text-center mb-5">
                                <div className="mb-3 relative">
                                    {/* Icon Circle */}
                                    <div className="w-16 h-16 bg-gray-200 border-4 border-black rounded-full flex items-center justify-center text-black">
                                ...
                                <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2 uppercase leading-[0.9]">
                                    Mohon Maaf<br />
                                    <span className="text-black inline-block transform -rotate-2 bg-gray-200 px-3 border-2 border-black shadow-[4px_4px_0px_0px_#000000] mt-2">
                                        Belum Disetujui
                                    </span>
                                </h1>
                                ...
                                <p className="text-sm md:text-base font-bold text-black max-w-lg mt-2">
                                    Pendaftaran Anda sebagai affiliator Qutab belum dapat kami setujui saat ini.
                                </p>
                            </div>
                            ...
                            <div className="bg-[#fffbef] border-2 border-black p-3.5 md:p-4 shadow-[4px_4px_0px_0px_#000000] mb-5">
                                <div className="flex gap-3">
                                    ...
                                    <p className="text-sm md:text-base font-bold leading-relaxed text-black">
                                        <span className="font-black">Alasan:</span> {rejectionReason} Silakan perbaiki dan hubungi{' '}
                                        <span className="bg-[#ffafcc] px-1.5 font-black border border-black">support@qutab.id</span>{' '}
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center bg-white p-3 border-2 border-black hover:bg-[#fffbef] transition-colors">
                                        ...
                                        <p className="font-bold text-sm md:text-base text-black">
                                            Perbaiki hal-hal yang disebutkan dalam alasan penolakan
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center bg-white p-3 border-2 border-black hover:bg-[#fffbef] transition-colors">
                                        ...
                                        <p className="font-bold text-sm md:text-base text-black">
                                            Hubungi tim support jika ada pertanyaan atau kesalahan
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center bg-white p-3 border-2 border-black hover:bg-[#fffbef] transition-colors">
                                        ...
                                        <p className="font-bold text-sm md:text-base text-black">
                                            Anda dapat mendaftar ulang setelah 30 hari
                                        </p>
                                    </div>
                                </div>
                            </div>
